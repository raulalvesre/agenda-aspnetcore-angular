...
namespace Agenda.Infrastructure.Migrations
{
    ...
    [Migration("20210423173457_FixPasswordName")]
    partial class FixPasswordName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agenda.Domain.Models.Types.InteractionType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Agenda.Domain.Models.Types.TelephoneType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Agenda.Domain.Models.Types.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Agenda.Domain.Models.ContactTelephone", b =>
                {
                    ...
                    b.HasOne("Agenda.Domain.Models.Types.TelephoneType", "TelephoneType")
                        .WithMany()
            ...
            modelBuilder.Entity("Agenda.Domain.Models.Interaction", b =>
                {
                    b.HasOne("Agenda.Domain.Models.Types.InteractionType", "InteractionType")
                        .WithMany()
            ...
            modelBuilder.Entity("Agenda.Domain.Models.User", b =>
                {
                    b.HasOne("Agenda.Domain.Models.Types.UserRole", "Role")
                        .WithMany()
